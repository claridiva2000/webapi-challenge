...
- it makes it easier to create web applications and services, but since it is so simple, it is not an end-all solution and usually requires additional middleware.
...
- [ ] Describe a Resource?
A resource is the actual object brought back through the api. ex. a list of hobbits through a GET call.
